<x-navbar-layout>
    ...
    <div class="fw-bolder fs-6 mt-3">
        <h3 class="fw-bolder mt-2">Question: {{ ucfirst($question->title) }}</h3>

        <p class="mt-2">Description:{!! ucfirst($question->description) !!}
        </p>
        <p>
            <small>
    ...
    <div class="card mb-3 mt-3">
        ...
        <div class="card-footer">
            <small class=" fs-5 ">
                Answered: <br>
                <div class=" mt-2 ">
                    <img src="{{ $answer->user->avatar }}" alt="{{ $answer->user->username }}" width="30" height="30">
